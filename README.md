...
Button.Image = "rbxassetid://98216492508597"
...
wait(1.0)
Tabs.Info:AddButton({
        Title="thaidz Premium Community",
        Description="Discord",
        Callback=function()
            setclipboard(tostring("https://discord.gg/tboyroblox-community-1253927333920899153")) 
        end
})
Tabs.Info:AddButton({
    Title="thaidz Premium",
    Description="Youtube",
    Callback=function()
...
_G.FastAttackVxeze_Mode="lọ Super Fast Attack"
spawn(function()
    while wait() do
        if _G.FastAttackVxeze_Mode then
            pcall(function()
                if _G.FastAttackVxeze_Mode=="lọ Super Fast Attack" then
